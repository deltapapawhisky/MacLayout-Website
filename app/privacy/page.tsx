        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-3">Application Data (Stored Locally)</h3>
              <p className="text-slate-600 mb-4">
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-3">Update Checks</h3>
              <p className="text-slate-600 mb-4">
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-3">Website Analytics</h3>
              <p className="text-slate-600 mb-4">
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-600">
                <a href="mailto:support@maclayout.com" className="text-primary-600 hover:underline">
