...
export default function AutomateMacWorkspace() {
  ...
  const articleJsonLd = {
    ...
    '@type': 'Article',
    headline: 'How to Automate Your Mac Workspace with Display Triggers',
    datePublished: '2026-03-25',
    author: { '@type': 'Person', name: 'Daniel White' },
    publisher: { '@type': 'Organization', name: 'MacLayout', url: 'https://maclayout.com' },
    description: 'Learn how to automatically restore your window layouts when you dock or undock your MacBook. Set up display change triggers and app launch triggers for a seamless workflow.',
    url: 'https://maclayout.com/blog/automate-mac-workspace-display-triggers',
  }
