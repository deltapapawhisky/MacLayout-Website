          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <aside className="lg:w-64 flex-shrink-0">
              <div className="lg:sticky lg:top-24">
                <h2 className="text-lg font-bold text-slate-900 mb-4">User Guide</h2>
            ...
            <div className="flex-1 max-w-3xl">
              <div className="prose prose-slate max-w-none">
                ...
                <section id="accessibility" className="mb-16">
                  <h2 className="text-2xl font-bold text-slate-900 mb-4">Accessibility Permission</h2>
                  ...
                  <div className="bg-slate-100 rounded-xl p-6 mb-6">
                    <h3 className="font-semibold text-slate-900 mb-3">How to grant permission:</h3>
                  ...
                  <div className="bg-amber-50 border border-amber-200 rounded-xl p-6">
                    <h3 className="font-semibold text-amber-900 mb-2">Privacy Note</h3>
                ...
                <section id="saving-layouts" className="mb-16">
                  <h2 className="text-2xl font-bold text-slate-900 mb-4">Saving Layouts</h2>
                  <p className="text-slate-600 mb-6">
                    A layout captures the position and size of all your open windows, along with
                    which apps they belong to.
                  </p>

                  <h3 className="text-lg font-semibold text-slate-900 mb-3">To save a layout:</h3>
                  ...
                  <div className="bg-slate-100 rounded-xl p-6">
                    <h3 className="font-semibold text-slate-900 mb-2">What gets saved:</h3>
                ...
                <section id="restoring-layouts" className="mb-16">
                  <h2 className="text-2xl font-bold text-slate-900 mb-4">Restoring Layouts</h2>
                  <p className="text-slate-600 mb-6">
                    Restore a saved layout to instantly arrange your windows back to their saved positions.
                  </p>

                  <h3 className="text-lg font-semibold text-slate-900 mb-3">Ways to restore:</h3>
                  ...
                  <div className="bg-primary-50 rounded-xl p-6">
                    <h3 className="font-semibold text-primary-900 mb-2">Smart Restoration</h3>
                ...
                <section id="keyboard-shortcuts" className="mb-16">
                  <h2 className="text-2xl font-bold text-slate-900 mb-4">Keyboard Shortcuts</h2>
                  <p className="text-slate-600 mb-6">
                    Assign global keyboard shortcuts to your layouts for instant access without using the mouse.
                  </p>

                  <h3 className="text-lg font-semibold text-slate-900 mb-3">To assign a shortcut:</h3>
                  <ol className="list-decimal list-inside text-slate-700 space-y-2 mb-6">
                  ...
                  <div className="bg-slate-100 rounded-xl p-6">
                    <h3 className="font-semibold text-slate-900 mb-2">Recommended shortcuts:</h3>
                    <ul className="text-slate-700 space-y-1">
                      <li><code className="bg-slate-200 px-2 py-1 rounded">⌘⌥1</code> - Primary layout</li>
                      <li><code className="bg-slate-200 px-2 py-1 rounded">⌘⌥2</code> - Secondary layout</li>
                      <li><code className="bg-slate-200 px-2 py-1 rounded">⌘⌥F</code> - Focus mode</li>
                    </ul>
                  </div>
                </section>
                ...
                <section id="multi-monitor" className="mb-16">
                  <h2 className="text-2xl font-bold text-slate-900 mb-4">Multi-Monitor Setup</h2>
                  <p className="text-slate-600 mb-6">
                    MacLayout fully supports multi-monitor setups and intelligently adapts
                    to different display configurations.
                  </p>

                  <h3 className="text-lg font-semibold text-slate-900 mb-3">Display-aware features:</h3>
                  <ul className="list-disc list-inside text-slate-700 space-y-2 mb-6">
                  ...
                  <div className="bg-primary-50 rounded-xl p-6">
                    <h3 className="font-semibold text-primary-900 mb-2">Tip: Create setup-specific layouts</h3>
                    <p className="text-primary-800 text-sm">
                ...
                <section id="automation" className="mb-16">
                  <h2 className="text-2xl font-bold text-slate-900 mb-4">Automation Triggers</h2>
                  <p className="text-slate-600 mb-6">
                    Set up automatic triggers to restore layouts without any manual intervention.
                  </p>

                  <h3 className="text-lg font-semibold text-slate-900 mb-3">Display Change Trigger</h3>
                  ...
                  <h3 className="text-lg font-semibold text-slate-900 mb-3">App Launch Trigger</h3>
                  <p className="text-slate-600 mb-4">
                ...
                <section id="preferences" className="mb-16">
                  <h2 className="text-2xl font-bold text-slate-900 mb-4">Preferences</h2>
                  <p className="text-slate-600 mb-6">
                    Access preferences by clicking the menu bar icon and selecting "Preferences".
                  </p>

                  <h3 className="text-lg font-semibold text-slate-900 mb-3">Available settings:</h3>
                ...
                <section id="troubleshooting" className="mb-16">
                  ...
                  <div className="space-y-6">
                    <div className="bg-slate-100 rounded-xl p-6">
                      <h3 className="font-semibold text-slate-900 mb-2">Windows aren't moving</h3>
                    ...
                    <div className="bg-slate-100 rounded-xl p-6">
                      <h3 className="font-semibold text-slate-900 mb-2">Layout doesn't match exactly</h3>
                      <p className="text-slate-700 text-sm">
                    ...
                    <div className="bg-slate-100 rounded-xl p-6">
                      <h3 className="font-semibold text-slate-900 mb-2">Keyboard shortcut not working</h3>
                      <p className="text-slate-700 text-sm">
                    ...
                    <div className="bg-slate-100 rounded-xl p-6">
                      <h3 className="font-semibold text-slate-900 mb-2">App not capturing some windows</h3>
                      <p className="text-slate-700 text-sm">
                  ...
                  <div className="mt-8 bg-primary-50 rounded-xl p-6">
                    <h3 className="font-semibold text-primary-900 mb-2">Still having issues?</h3>
